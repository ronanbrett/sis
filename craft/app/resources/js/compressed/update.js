...
{data:this.data},b.proxy(function(a,c,b){if("success"==c&&a.alive)this.onSuccessResponse(a);else this.onErrorResponse(b)},this),{complete:b.noop})},onSuccessResponse:function(a){a.data&&(this.data=a.data);a.errorDetails&&(this.$errorDetails=a.errorDetails);a.nextStatus&&this.updateStatus(a.nextStatus);a.nextAction&&this.postActionRequest(a.nextAction);if(a.finished){var b=!1;a.rollBack&&(b=!0);this.onFinish(a.returnUrl,b)}},onErrorResponse:function(a){this.$graphic.addClass("error");a=Craft.t("An error has occurred.  Please contact {email}.",
{email:'<a href="mailto:support@buildwithcraft.com?subject=Update+Failure&body='+encodeURIComponent(a.responseText)+'">support@buildwithcraft.com</a>'})+"<br /><p>"+a.statusText+"</p><br /><p>"+a.responseText+"</p>";this.updateStatus(a)},onFinish:function(a,b){if(this.$errorDetails){this.$graphic.addClass("error");var c=Craft.t("Craft was unable to install this update. :(")+"<br /><p>",c=b?c+(Craft.t("The site has been restored to the state it was in before the attempted update.")+"</p><br /><p>"):
c+(Craft.t("No files have been updated and the database has not been touched.")+"</p><br /><p>"),c=c+(this.$errorDetails+"</p>");this.updateStatus(c)}else this.updateStatus(Craft.t("All done!")),this.$graphic.addClass("success"),setTimeout(function(){window.location=a?Craft.getUrl(a):Craft.getUrl("dashboard")},500)}})})(jQuery);
